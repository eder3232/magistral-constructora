...
export function CaracteristicasV2() {
  ...
  return (
    <section
      ...
      className="bg-brand-cream py-16 md:py-24 lg:py-32"
    >
                ...
                >
                  ...
                  >
                    <div className="relative aspect-[16/10] w-full shrink-0 md:aspect-auto md:w-2/5 md:min-h-[280px]">
                      ...
                      />
                      <div
                        className="absolute left-0 right-0 top-0 h-1 bg-brand-orange"
                        aria-hidden
                      />
                    </div>
          ...
          <div className="mt-6 flex justify-center gap-2">
            {ITEMS.map((_, index) => (
              <button
                ...
                className={cn(
                  "h-2.5 w-2.5 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2",
                  selectedIndex === index
                    ? "scale-125 bg-brand-orange"
                    : "bg-brand-gray-soft/50 hover:bg-brand-gray-soft"
                )}
              />
            ))}
          </div>
