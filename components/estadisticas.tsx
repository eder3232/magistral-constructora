...
export function Estadisticas() {
  ...
  return (
    <section
      ...
      className="bg-brand-navy-dark px-4 py-16 md:px-8 md:py-24 lg:px-16 lg:py-32"
    >
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-16 text-center font-display text-lg italic text-brand-white/80 md:text-xl">
