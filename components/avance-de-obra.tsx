...
export function AvanceDeObra() {
  ...
  return (
    <section
      ...
      className="bg-brand-cream px-4 py-16 md:px-8 md:py-24 lg:px-16 lg:py-32"
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-10 lg:mt-16 lg:grid-cols-2 lg:items-start lg:gap-16">
          ...
          <div className="order-1 overflow-hidden rounded-xl lg:order-1">
            <video
              src="/landing/avance/avance_obra.mp4"
          ...
          <div className="order-2 relative lg:order-2">
            <div className="relative flex flex-col">
              ...
              <div className="absolute left-[19px] top-0 h-full w-0.5 bg-brand-gray-soft/40 md:left-6">
                <div
                  ref={lineRef}
                  className="h-full w-full origin-top bg-brand-orange"
                ...
                >
                  ...
                  <div className="relative z-10 flex shrink-0 items-center justify-center">
                    {hito.status === "completado" ? (
                      <div className="flex size-10 items-center justify-center rounded-full bg-brand-orange text-brand-white md:size-12">
                        <Check className="size-5 md:size-6" strokeWidth={2.5} />
                      </div>
                    ) : hito.status === "en-curso" ? (
                      <div className="avance-obra-en-curso flex size-10 items-center justify-center rounded-full border-2 border-brand-orange bg-brand-cream text-brand-orange md:size-12">
                        <Loader2
                      ...
                      <div className="flex size-10 items-center justify-center rounded-full border-2 border-brand-gray-soft bg-brand-cream text-brand-gray-soft md:size-12">
                        <Circle className="size-4 md:size-5" fill="currentColor" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="min-w-0 flex-1 pt-1">
                    ...
                    {hito.status === "completado" && (
                      <span className="mt-2 inline-block text-xs font-medium text-brand-orange">
                        Completado
                      </span>
                    )}
                    {hito.status === "en-curso" && (
                    ...
                    {hito.status === "proximo" && (
                      <span className="mt-2 inline-block text-xs font-medium text-brand-gray-soft">
                        Próximo
                      </span>
                    )}
                  </div>
