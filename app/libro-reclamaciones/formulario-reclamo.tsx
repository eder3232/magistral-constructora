...
export function FormularioReclamo() {
  ...
  if (success) {
    return (
      <div className="mx-auto max-w-xl rounded-xl border border-brand-orange/40 bg-white p-8 text-center shadow-lg md:p-10">
        <CheckCircle2 className="mx-auto size-14 text-brand-orange" />
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="mx-auto max-w-2xl space-y-6 rounded-xl bg-brand-cream/95 p-6 text-foreground shadow-lg md:p-8"
      >
        {submitError && (
          <div
            role="alert"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder={form.watch("tipoDocumento") === "DNI" ? "8 dígitos" : "9-15 caracteres"}
                      className="min-h-[44px]"
                      inputMode={form.watch("tipoDocumento") === "DNI" ? "numeric" : "text"}
