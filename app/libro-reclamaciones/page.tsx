...
export default function LibroReclamacionesPage() {
  return (
    <>
      ...
      <section
        className="relative flex min-h-[45vh] items-center justify-center overflow-hidden bg-brand-navy-dark"
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-16 md:px-8 md:py-24 lg:px-16 lg:py-32">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-4 h-1 w-10 rounded-full bg-brand-orange" />
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-16 md:px-8 md:py-24 lg:px-16 lg:py-32">
          <h2
            id="form-heading"
            className="font-display text-3xl font-bold text-brand-white md:text-4xl lg:text-5xl"
          >
            Registre su reclamo o queja
          </h2>
          <div className="mt-4 h-1 w-10 rounded-full bg-brand-orange" />
          <p className="mt-6 text-base text-brand-white/90 lg:text-lg">
